package gtisc.gpl_violation.permission;
...
public class PermissionUtil {
	...
	public static String PERM_JAVA_CODE_LOADING = "legoandroid.permission.JAVA_CODE_LOADING";
	public static String PERM_NATIVE_CODE_LOADING = "legoandroid.permission.NATIVE_CODE_LOADING";
